    ...
    "columns": [{
        ...
        },
        {
            "render": function (data, type, full) {
                ...
                var button = `<button type="button" onclick='addToList(${obj})' class="btn btn-success btn-sm">เบิก  <span class="badge badge-light" id="m${full.id}"></span></button>`;
                if(full.amount == 0){
                    button = `<button type="button" class="btn btn-danger btn-sm" disabled>หมดสต๊อก</button>`;
                }
                return  button;
            }
        },
